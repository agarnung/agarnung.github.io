...
<div style="text-align:center;">
  <video controls width="640">
    <source src="https://raw.githubusercontent.com/agarnung/srinivasa-says/main/assets/full_video.mp4" type="video/mp4">
  </video>
</div>
...
* **Desarrollo de firmware**: [WinAVR](https://winavr.sourceforge.net/) y [avr-gcc](https://winavr.sourceforge.net/) para compilar código en c puro. Usado a través de [Microchip Stuio](https://www.microchip.com/en-us/tools-resources/develop/microchip-studio) (antes [Atmel Studio](https://www.microchip.com/en-us/tools-resources/develop/microchip-studio)).
...
> [!TIP] Véase el [proyecto enlazado](https://github.com/agarnung/srinivasa-says) al principio para toda la documentación y los adjuntos al completo.
