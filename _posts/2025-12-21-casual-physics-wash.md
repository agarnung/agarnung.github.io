...
>
> Ya no es solamente que el aceite "flote" en el agua al tener menos densidad (efecto de flotabilidad; líquidos inmiscibles) (1000 kg/m^3 para el agua, ≈ 850 kg/m^3 para el aceite), sino que, además, no se pueden mezclar. Esto ocurre [porque](https://web.fscj.edu/Milczanowski/psc/lect/Ch10/slide10.htm) las moleculas de agua son polares y se atraen más entre ellas, mientras que las moléculas de aceite son apolares y no se atraigan con las de agua.
