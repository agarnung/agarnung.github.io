...
style: fill
color: danger
description: Visualización 3D de la Evolución de Imágenes bajo Ecuaciones Diferenciales Parciales
image: https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Heat.gif/330px-Heat.gif
---

Una [aplicación web interactiva](https://agarnung.github.io/threepde/) que transforma imágenes bidimensionales en visualizaciones tridimensionales dinámicas mediante la resolución numérica de ecuaciones diferenciales parciales (PDEs). Este proyecto combina técnicas avanzadas de procesamiento de imágenes, métodos numéricos de diferencias finitas, y renderizado 3D en tiempo real utilizando WebGL y Three.js.
...
**Casos especiales**:
- **Zero**: 
$$u|_{\partial \Omega} = 0$$ (valores fijos en cero)
- **Fixed**: 
$$u|_{\partial \Omega} = u_0|_{\partial \Omega}$$ (valores originales de la imagen inicial)
...
**Caso especial**:
- **Reflective**: 
$$\frac{\partial u}{\partial n}|_{\partial \Omega} = 0$$ (sin flujo a través del borde, como un espejo)
...
Para más información sobre condiciones de contorno, consulta: [Wikipedia](https://en.wikipedia.org/wiki/Boundary_value_problem#Examples).
...
Para opciones de uso de Three.js en proyectos, consulta: [discourse.threejs.org](https://discourse.threejs.org/t/help-getting-set-up-with-vscode-and-three-js/19606).
