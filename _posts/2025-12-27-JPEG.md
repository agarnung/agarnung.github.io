...
$$F_{reconstruido}(u,v) = F_{quant}(u,v) × Q(u,v)$$
...
$$Q_{escalada} = Q × (factor_{escala} / 50)$$
...
- **Longitud promedio**: $$L = Σ p_i × l_i$$ (donde $$l_i$$ es la longitud del código para el símbolo $$i$$).
...
>
> Fórmula: $$H = -Σ p_i × log_2(p_i)$$, donde $$p_i$$ es la probabilidad de cada símbolo.
>
> Ejemplo práctico:
